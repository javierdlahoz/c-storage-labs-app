...
class CategoriasController extends AppController {
    ...
    public function view($id = null) {
        ...
        $this->set('categorias', $this->Categoria->find('all', array('conditions' => array('cpadre' => $id))));
    }
    ...
    //FUNCII�N SEARCH CON EL AUTOCOMPLETE
    function index() {
    ...
    public function edit($id = null) {
        ...
        if ($this->request->is('post') || $this->request->is('put')) {
            if ($this->Categoria->save($this->request->data)) {
                $this->Session->setFlash(__('Categor�a modificada'));
                $this->redirect(array('action' => 'index', $cpadre));
            } else {
                $this->Session->setFlash(__('Ha habido un problema, intentelo m�s tarde'));
            }
        }
    }
